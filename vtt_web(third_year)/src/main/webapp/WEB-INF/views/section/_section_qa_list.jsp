...
<tr name ="qaSecTr" id="qaSecTr_${result.sectionid}" onclick="setQaSectionInfo(this)">
...
<tr name ="qaSecTr" id="qaSectionTr_new" onclick="setQaSectionInfo(this)" style="display:none;">
