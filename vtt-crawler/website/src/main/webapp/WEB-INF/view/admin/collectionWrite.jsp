...
<head>
	...
	<script type="text/javascript">
		function fnSave(){
			...
			var formOptions = {
				url : '/admin/collectionSave',
				type : 'POST',
				beforeSend : function(){},
				success : function(response) {
					if(response.resultCode != RESULT_CODE.ERROR){
						alert('저장 되었습니다.');
						location.href='/admin/collectionList';
					}else{
		...
		<div class="header-inner">		    
			...
			<div class="gnb">
				<ul class="nav">                    
					...
					<li class="depth01 menu02 active"><a href="/admin/collectionWrite">스케줄 등록</a></li>
	...
	<div id="content">
		...
		<div class="notice-write">
						...
						<div>
							<table>
								<tr>
									...
									<td style="width:200px"><div class="input-text"><input type="text" id="FILE_SIZE_VALUE" name="SC_MAXSIZE" value="200"></div></td>
			...
			<div class="button-area medium">
				<a href="/admin/collectionList" class="btn type04 medium">취소</a>
