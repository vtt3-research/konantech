		...
		,	tableViewStart: function fnSetTableView() {
			...
			,	binder: {
					collectionSubject: function(item) {
						location.href='/admin/collectionView?SID='+item.SID; 
					}
				}
...
<div id="header" class="active"> <!-- // 활성화 시 active 클래스 추가 -->
	...
	<div class="header-wrap active"> <!-- // 활성화 시 active 클래스 추가 -->
		<div class="header-inner">		    
			...
			<div class="gnb">				
				<ul class="nav">
					<li class="depth01 menu01 active"><a href="/admin/collectionList">스케줄 조회</a></li>
...
<div id="content">
	...
	<fieldset class="fieldset large">
		...
		<div class="field">
			...
			<div class="insert">
				<label class="label" for="input03">수집원</label>
				<div class="input-text" style="width: 100px;"><input type="text" id="USER_ID_VALUE" placeholder="수집원"></div>
			</div>					
			<button type="button" class="btn type01 medium" onclick="fnSearch();">조회<span class="ico-search"></span></button>
		</div>
	</fieldset>
	
	<form name="frm" id="frm" action="/admin/collectionList">	
