...
<head>
	...
	<script type="text/javascript">
		function fnSave(){
			...
			if(fnIsEmpty($('#ID_VALUE').val())){
				$('#ID_VALUE').focus();
				return;
			}
			
			var formOptions = {
				url : '/admin/memberSave',
				type : 'POST',
				beforeSend : function(){},
...
<div id="container" class="sub">
	<div id="content">
		<div class="title-wrap">
			<h1 class="content-title">수집원 계정 등록</h1>			    
		</div>
		...
		<div class="notice-write">
			<form name="frm" id="frm" onsubmit="return false;">				
				...
				<div class="view-header">
					<div class="insert">
						...
						<div class="input-text"><input type="text" id="ID_VALUE" name="ID"></div>
					</div>	
					<div class="insert">
							...
							<table>
								<tr>
									<td style="width:450px">
										<div class="input-text"><input type="text" id="PASSWORD_VALUE" name="PASSWORD"></div>										
									</td>
			...
			<div class="button-area medium">
				<a href="/admin/memberList" class="btn type04 medium">취소</a>
