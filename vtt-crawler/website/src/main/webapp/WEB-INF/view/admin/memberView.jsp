		...
		<div class="notice-write">
			<form name="frm" id="frm"  onsubmit="return false;">
				<div class="view-header">
					<div class="insert">
						<div class="label">수집원아이디</div>					
						<div class="input-text"><input type="text" id="ID_VALUE" name="ID" <c:if test="${not empty memberInfo.ID}"> value="${memberInfo.ID}"</c:if> readonly="readonly"></div>
					</div>	
					<div class="insert">
							...
							<table>
								<tr>
									<td style="width:450px">
										<div class="input-text"><input type="text" id="PASSWORD_VALUE" name="PASSWORD" <c:if test="${not empty memberInfo.PASSWORD}"> value="${memberInfo.PASSWORD}"</c:if>></div>										
									</td>
									<td style="width:150px"><div class="label1" style="width:110px">관리자여부</div></td>
									<td style="width:450px">
										<select name="ISADMIN" id="ISADMIN_VALUE"  style="width: 200px; padding-left: 10px;">
											<option value="N" <c:if test="${memberInfo.ISADMIN == 'N'}"> selected="selected"</c:if>>일반사용자</option>
											<option value="Y" <c:if test="${memberInfo.ISADMIN == 'Y'}"> selected="selected"</c:if>>관리자</option>								   												
										</select>								
									</td>																			
								</tr>
							</table>
			...
			<div class="button-area medium">
				<a href="/admin/memberList" class="btn type04 medium">리스트</a>
